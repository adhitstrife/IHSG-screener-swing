  ...
  return <main className="min-h-screen bg-[#f6f8fb] text-slate-900">
    ...
    <div className="mx-auto max-w-7xl px-5 py-8 lg:px-8">
      ...
      <section className="mt-7 grid gap-5 lg:grid-cols-2">
        <div className="rounded-2xl border border-slate-200 bg-white p-5"><h2 className="font-bold">Cara membaca kualitas</h2><p className="mt-3 text-sm leading-6 text-slate-600">Setup Quality menilai struktur tren, breakout/pullback, volume, relative strength terhadap IHSG, turnover, dan regime pasar. Entry Quality menilai extension dari EMA20, risiko, R:R, RSI, posisi breakout, serta kualitas candle. Overall = Setup 60% + Entry 40%.</p><p className="mt-3 text-xs leading-5 text-slate-500">Target memakai resistance historis hingga 220 sesi. Jika tidak ada resistance valid, target diberi label Projected 3R; sistem tidak menaikkan target hanya untuk mengejar R:R.</p></div>
