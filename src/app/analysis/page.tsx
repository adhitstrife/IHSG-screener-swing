...
type Analysis = {
  ...
  fundamental: { score: number; summary: string; positives: string[]; risks: string[]; data: FundamentalData; web: { coverage: "available" | "not-configured" | "unavailable"; provider: "firecrawl" | "tavily" | null; warning: string | null }; sources: WebSource[] };
  disclaimer: string;
};
