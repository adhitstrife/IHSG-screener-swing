...
const compile = spawnSync(process.execPath, [
  ...
  'src/types/pdf-parse-worker.d.ts', 'src/lib/market-data.ts', 'src/lib/swing-strategy.ts', 'src/lib/swing-backtest.ts', 'src/lib/screener.ts', 'src/lib/yahoo-finance.ts', 'src/lib/yahoo-data.ts', 'src/lib/fundamental-research.ts', 'src/lib/stock-analysis.ts', 'src/lib/screener-storage.ts', 'src/lib/dividend-parser.ts', 'src/lib/dividend-source.ts', 'src/lib/dividend-storage.ts',
